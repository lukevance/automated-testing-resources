...
// When the power status is on, and the toasting status is on,
// and the power function is called, it should set the
// power status and the toasting status to off.
